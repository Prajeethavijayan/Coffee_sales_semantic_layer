An end-to-end analytics platform and AI agent built on DuckDB and Ollama. This project transforms raw CSV transactional data into a structured business semantic layer and provides a natural language to SQL (NL2SQL) interface for querying business performance.
